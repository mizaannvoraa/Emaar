  ...
  return (
    <div className={`md:pb-4 ${isThankYouPage ? 'pb-3' : 'pb-14'} py-4 px-4 text-[13px] lato bg-[#F2F2F2] text-black flex flex-row items-center justify-center space-x-7 text-center`}>
      <Link
        ...
        className="mid_text hover:underline tracking-widest font-semibold"
      >
        PRIVACY POLICY
      </Link>
      ...
      <Link
        ...
        className="mid_text hover:underline tracking-widest uppercase font-semibold"
      >
        TERMS & CONDITIONS
      </Link>
       <span className="border-l h-4 border-black"></span>
     <p className=" mid_text tracking-widest uppercase font-semibold">Designed by  <Link
        href="https://www.nuvoraa.com/"
        className="mid_text hover:underline tracking-widest uppercase font-black"
      >Nuvoraa</Link></p>
